...
var ArgsStore = /*#__PURE__*/function () {
  ...
  _createClass(ArgsStore, [{
    ...
    key: "setInitial",
    value: function setInitial(storyId, args) {
    ...
    key: "resetOnImplementationChange",
    value: function resetOnImplementationChange(story, previousStory) {
      var delta = (0, _args.deepDiff)(previousStory.initialArgs, this.get(story.id));
