...
function processCSFFile(moduleExports, title) {
  ...
  checkDisallowedParameters(meta.parameters); // prefer a user/loader provided `__namedExportsOrder` array if supplied
  ...
  Object.keys(exports).forEach(function (key) {
    if ((0, _csf.isExportStory)(key, meta)) {
      var storyMeta = (0, _normalizeStory.normalizeStory)(key, exports[key], meta);
