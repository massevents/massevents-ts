  ...
  function StoryStore() {
    ...
    this.getStoriesJsonData = function () {
      ...
      var stories = (0, _mapValues.default)(value.stories, function (story) {
        ...
        }, !(FEATURES !== null && FEATURES !== void 0 && FEATURES.breakingChangesV7) && {
          kind: story.title,
          story: story.name,
  ...
  _createClass(StoryStore, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return this.cacheAllCSFFiles(false);
    ...
    value: function loadCSFFileByStoryId(storyId) {
      ...
      var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          _ref4$sync = _ref4.sync,
          sync = _ref4$sync === void 0 ? false : _ref4$sync;
      ...
      var moduleExportsOrPromise = this.importFn(importPath);
      ...
      if (sync) {
        ...
        if (Promise.resolve(moduleExportsOrPromise) === moduleExportsOrPromise) {
          throw new Error("importFn() returned a promise, did you pass an async version then call initialize({sync: true})?");
        } // We pass the title in here as it may have been generated by autoTitle on the server.


        return this.processCSFFileWithCache(moduleExportsOrPromise, title);
      }

      return Promise.resolve(moduleExportsOrPromise).then(function (moduleExports) {
        return (// We pass the title in here as it may have been generated by autoTitle on the server.
          _this2.processCSFFileWithCache(moduleExports, title)
        );
      });
    }
  }, {
    key: "loadAllCSFFiles",
    value: function loadAllCSFFiles(sync) {
      var _this3 = this;

      var importPaths = {};
      Object.entries(this.storyIndex.stories).forEach(function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 2),
            storyId = _ref6[0],
            importPath = _ref6[1].importPath;

        importPaths[importPath] = storyId;
      });
      var csfFileList = Object.entries(importPaths).map(function (_ref7) {
        ...
        return {
          ...
          csfFileOrPromise: sync ? _this3.loadCSFFileByStoryId(storyId, {
            sync: true
          }) : _this3.loadCSFFileByStoryId(storyId, {
            sync: false
          })
        };
      });
      ...
      function toObject(list) {
        return list.reduce(function (acc, _ref9) {
          var importPath = _ref9.importPath,
      ...
      if (sync) {
        return toObject(csfFileList.map(function (_ref10) {
          var importPath = _ref10.importPath,
              csfFileOrPromise = _ref10.csfFileOrPromise;
          return {
            importPath: importPath,
      ...
      return Promise.all(csfFileList.map( /*#__PURE__*/function () {
        var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref11) {
          var importPath, csfFileOrPromise;
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  importPath = _ref11.importPath, csfFileOrPromise = _ref11.csfFileOrPromise;
                  _context2.t0 = importPath;
                  _context2.next = 4;
                  return csfFileOrPromise;

                case 4:
                  _context2.t1 = _context2.sent;
                  return _context2.abrupt("return", {
                    importPath: _context2.t0,
                    csfFile: _context2.t1
                  });
    ...
    value: function cacheAllCSFFiles(sync) {
      var _this4 = this;
      ...
      return this.loadAllCSFFiles(false).then(function (csfFiles) {
    ...
    key: "loadStory",
    value: function () {
      var _loadStory = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref13) {
        var storyId, csfFile;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                storyId = _ref13.storyId;
                _context3.next = 3;
              ...
              case 5:
                csfFile = _context3.sent;
                return _context3.abrupt("return", this.storyFromCSFFile({
                  storyId: storyId,
                  csfFile: csfFile
                }));
    ...
    value: function storyFromCSFFile(_ref14) {
      var storyId = _ref14.storyId,
          csfFile = _ref14.csfFile;
    ...
    value: function componentStoriesFromCSFFile(_ref15) {
      var _this5 = this;

      var csfFile = _ref15.csfFile;
    ...
    value: function extract() {
      ...
      return Object.entries(this.storyIndex.stories).reduce(function (acc, _ref16) {
        var _ref17 = _slicedToArray(_ref16, 2),
            storyId = _ref17[0],
            importPath = _ref17[1].importPath;
        ...
        acc[storyId] = Object.entries(story).reduce(function (storyAcc, _ref18) {
    ...
    value: function getSetStoriesPayload() {
      ...
      var kindParameters = Object.values(stories).reduce(function (acc, _ref20) {
    ...
    value: function raw() {
      ...
      return Object.values(this.extract()).map(function (_ref21) {
        var id = _ref21.id;
