import { DecoratorFunction, Args, StoryContextForEnhancers, StoryId, StoryName, StoryIdentifier, ViewMode, LegacyStoryFn, StoryContextForLoaders, StoryContext, ComponentTitle, AnyFramework, ProjectAnnotations, ComponentAnnotations, StoryAnnotations, StoryFn, StrictArgTypes, StrictGlobalTypes, ComponentId, PartialStoryFn, Parameters } from '@storybook/csf';
export { StoryId, Parameters };
export declare type Path = string;
export declare type ModuleExports = Record<string, any>;
export declare type ModuleImportFn = (path: Path) => Promise<ModuleExports> | ModuleExports;
...
export declare type NormalizedStoryAnnotations<TFramework extends AnyFramework = AnyFramework> = Pick<StoryAnnotations<TFramework>, Exclude<keyof StoryAnnotations<TFramework>, 'storyName' | 'story'>> & {
    id: StoryId;
    argTypes?: StrictArgTypes;
