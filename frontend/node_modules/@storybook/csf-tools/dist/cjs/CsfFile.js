  ...
  _createClass(CsfFile, [{
    ...
    value: function _parseMeta(declaration, program) {
      ...
      declaration.properties.forEach(function (p) {
        if (t.isIdentifier(p.key)) {
          ...
          if (p.key.name === 'title') {
            meta.title = _this._parseTitle(p.value);
          } else if (['includeStories', 'excludeStories'].includes(p.key.name)) {
            // @ts-ignore
            meta[p.key.name] = parseIncludeExclude(p.value);
          } else if (p.key.name === 'component') {
            var _generate = (0, _generator.default)(p.value, {}),
                code = _generate.code;
    ...
    value: function parse() {
            ...
            if (t.isVariableDeclaration(node.declaration)) {
              ...
              node.declaration.declarations.forEach(function (decl) {
                if (t.isVariableDeclarator(decl) && t.isIdentifier(decl.id)) {
                  ...
                  var name = (0, _csf.storyNameFromExport)(exportName);
      ...
      if (!self._meta.title && !self._meta.component) {
        throw new Error((0, _tsDedent.default)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        CSF: missing title/component ", "\n\n        More info: https://storybook.js.org/docs/react/writing-stories/introduction#default-export\n      "])), formatLocation(self._ast, self._fileName)));
...
var loadCsf = function loadCsf(code, options) {
...
var formatCsf = function formatCsf(csf) {
  var _generate2 = (0, _generator.default)(csf._ast, {}),
