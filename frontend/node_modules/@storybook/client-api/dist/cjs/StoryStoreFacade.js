...
var _global$STORIES = _global.default.STORIES,
...
var StoryStoreFacade = /*#__PURE__*/function () {
  ...
  _createClass(StoryStoreFacade, [{
    ...
    value: function importFn(path) {
      var moduleExports = this.csfExports[path];
    ...
    value: function getStoryIndex(store) {
      ...
      var sortableV6 = storyEntries.map(function (_ref) {
        ...
        var exports = _this.csfExports[importPath];
        var csfFile = store.processCSFFileWithCache(exports, exports.default.title);
        return [storyId, store.storyFromCSFFile({
          storyId: storyId,
          csfFile: csfFile
        }), csfFile.meta.parameters, _this.projectAnnotations.parameters];
    ...
    value: function addStoriesFromExports(fileName, fileExports) {
      ...
      title = title || (0, _store.autoTitle)(fileName, STORIES.map(function (specifier) {
      ...
      Object.entries(namedExports).filter(function (_ref6) {
