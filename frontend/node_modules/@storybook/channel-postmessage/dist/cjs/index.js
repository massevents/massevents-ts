  ...
  _createClass(PostmsgTransport, [{
    ...
    value: function send(event, options) {
      ...
      var _ref = options || {},
          ...
          allowFunction = _ref$allowFunction === void 0 ? true : _ref$allowFunction,
          ...
          maxDepth = _ref$maxDepth === void 0 ? 25 : _ref$maxDepth,
          space = _ref.space,
      ...
      var stringifyOptions = Object.assign({}, _global.default.CHANNEL_OPTIONS || {}, c); // backwards compat: convert depth to maxDepth
    ...
    value: function handleEvent(rawEvent) {
      try {
        ...
        var _ref4 = typeof data === 'string' && (0, _telejson.isJSON)(data) ? (0, _telejson.parse)(data) : data,
            key = _ref4.key,
            event = _ref4.event,
            refId = _ref4.refId;
