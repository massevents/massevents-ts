...
var _StoryIndexClient = require("./StoryIndexClient");
  ...
  _createClass(PreviewWeb, [{
    ...
    value: function initialize(_ref) {
      ...
      if (FEATURES !== null && FEATURES !== void 0 && FEATURES.storyStoreV7) {
        this.indexClient = new _StoryIndexClient.StoryIndexClient();
      ...
      this.channel.emit(_coreEvents.default.SET_STORIES, this.storyStore.getSetStoriesPayload());
    ...
    value: function getProjectAnnotationsOrRenderError(getProjectAnnotations) {
      ...
      try {
        ...
        _clientLogger.logger.warn(err); // This is an error extracting the projectAnnotations (i.e. evaluating the previewEntries) and
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 10:
                ...
                _context5.t1 = _coreEvents.default.SET_STORIES;
                _context5.next = 15;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                ...
                _clientLogger.logger.warn(_context6.t0);
              ...
              case 17:
                ...
                this.channel.emit(_coreEvents.default.STORY_UNCHANGED, selection.storyId);
                return _context6.abrupt("return");
              ...
              case 26:
                ...
                if (this.previousSelection && (storyIdChanged || viewModeChanged)) {
                  this.channel.emit(_coreEvents.default.STORY_CHANGED, selection.storyId);
                        ...
                        switch (_context7.prev = _context7.next) {
                          ...
                          case 3:
                            _context7.sent.renderDocs(story, fullDocsContext, element, function () {
                              return _this3.channel.emit(_coreEvents.default.DOCS_RENDERED, id);
                            });
                      ...
                      switch (_context8.prev = _context8.next) {
                        case 0:
                          if (!(_global.default !== null && _global.default !== void 0 && (_global$FEATURES2 = _global.default.FEATURES) !== null && _global$FEATURES2 !== void 0 && _global$FEATURES2.modernInlineRender)) {
                            _this3.channel.off(_coreEvents.default.UPDATE_GLOBALS, render);

                            _this3.channel.off(_coreEvents.default.UPDATE_STORY_ARGS, render);

                            _this3.channel.off(_coreEvents.default.RESET_STORY_ARGS, render);
                          }
              ...
              switch (_context12.prev = _context12.next) {
                        ...
                        while (1) {
                          switch (_context10.prev = _context10.next) {
                            case 0:
                              ...
                              _this5.channel.emit(_coreEvents.default.STORY_RENDER_PHASE_CHANGED, {
                                newPhase: phase,
                                storyId: id
                              });
                ...
                case 35:
                  ...
                  return runPhase('completed', function () {
                    return _this5.channel.emit(_coreEvents.default.STORY_RENDERED, id);
                  });
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _this5.channel.off(_coreEvents.default.UPDATE_GLOBALS, render);

                _this5.channel.off(_coreEvents.default.FORCE_RE_RENDER, render);

                _this5.channel.off(_coreEvents.default.FORCE_REMOUNT, remountStoryIfMatches);

                _this5.channel.off(_coreEvents.default.UPDATE_STORY_ARGS, rerenderStoryIfMatches);

                _this5.channel.off(_coreEvents.default.RESET_STORY_ARGS, rerenderStoryIfMatches); // Check if we're done rendering/playing. If not, we may have to reload the page.
    ...
    value: function renderException(storyId, error) {
      this.channel.emit(_coreEvents.default.STORY_THREW_EXCEPTION, error);
